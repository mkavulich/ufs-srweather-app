--[[
Test modulefile for loading Metdataio module
--]]
prepend_path("MODULEPATH","/scratch1/BMC/hmtb/kavulich/UFS/workdir/SRW_verification_plotting/rebase/METdataio/internal/scripts/installation/modulefiles/")
