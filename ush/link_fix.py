...
def link_fix(
    ...
    **kwargs,
    ...
    #       but for clarity, it is then renamed "C*_raw_orog.tile${TILE_RGNL}.halo${NHW}.nc".
    #
    ...
    #       "${CRES}_grid.tile${TILE_RGNL}.halo${NHW}.nc").  The executable then
    ...
    #
    #    b) C*_raw_orog.tile${TILE_RGNL}.halo${NHW}.nc
    ...
    #       "C*_filtered_orog.tile${TILE_RGNL}.halo${NHW}.nc" that will be
    ...
    #    file, which should be "C*_grid.tile${TILE_RGNL}.halo${NH4}.nc".  The
    #    dimensions specified in this grid file must match the ones specified
    #    in the (filtered) orography file "C*_oro_data.tile${TILE_RGNL}.halo${NH4}.nc"
    ...
    #    exist:
    #    a) "C*_mosaic.halo${NH4}.nc"
    #    b) "C*_grid.tile${TILE_RGNL}.halo${NH4}.nc"
    #    c) "C*_oro_data.tile${TILE_RGNL}.halo${NH4}.nc"
    #
    #
    # -----------------------------------------------------------------------
    #
    ...
    if file_group == "grid":
        fns = [
            ...
            f"C*_mosaic.halo{nh4}.nc",
            f"C*_mosaic.halo{nh3}.nc",
            f"C*_grid.tile{tile_rgnl}.halo{nhw}.nc",
            f"C*_grid.tile{tile_rgnl}.halo{nh3}.nc",
            f"C*_grid.tile{tile_rgnl}.halo{nh4}.nc",
        ]

    elif file_group == "orog":
        fns = [
            f"C*_oro_data.tile{tile_rgnl}.halo{nh0}.nc",
            f"C*_oro_data.tile{tile_rgnl}.halo{nh4}.nc",
        ]
        if ccpp_phys_suite == "FV3_RAP" or ccpp_phys_suite == "FV3_HRRR" or ccpp_phys_suite == "FV3_HRRR_gf" or ccpp_phys_suite == "FV3_GFS_v15_thompson_mynn_lam3km" or ccpp_phys_suite == "FV3_GFS_v17_p8" or ccpp_phys_suite == "RRFS_sas":
            fns += [
                f"C*_oro_data_ss.tile{tile_rgnl}.halo{nh0}.nc",
                f"C*_oro_data_ls.tile{tile_rgnl}.halo{nh0}.nc",
            ]
    ...
    #
    if file_group == "grid":
        target = f"{cres}_grid.tile{tile_rgnl}.halo{nh4}.nc"
        symlink = f"{cres}_grid.tile{tile_rgnl}.nc"
